 ...
 */
public class LayerFolderContentsTab extends GeoDetailsTabBase<Folder> {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        View v = inflater.inflate(R.layout.fragment_layer_folder_contents_tab, container, false);
