...
public class MainActivity extends Activity {
    ...
    private void selectItem(int position) {
        ...
        if (position == Views.MAP.value) { fragment = mMap; }
        else if (position == Views.LAYERS.value || position == Views.LIBRARY.value) { fragment = new RecyclerFragment(); }
        else if (position == Views.LOGOUT.value) { startActivity(new Intent(this, LoginActivity.class)); }
        //else if (position == Views.ACCOUNT.value) { fragment = new AccountFragment(); }
