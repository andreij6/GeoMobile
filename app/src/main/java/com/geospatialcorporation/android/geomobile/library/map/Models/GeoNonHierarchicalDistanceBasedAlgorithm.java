 ...
 */
public class GeoNonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    {
        final Collection<QuadItem<T>> items = new ArrayList<>();
        final PointQuadTree<QuadItem<T>> quadTree = new PointQuadTree<>(0, 1, 0, 1);
